...
class Metaclass_FaceDetector_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('chap4_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_FaceDetector(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'chap4_interface.srv.FaceDetector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from chap4_interface.srv import _face_detector
...
class FaceDetector(metaclass=Metaclass_FaceDetector):
    from chap4_interface.srv._face_detector import FaceDetector_Request as Request
    from chap4_interface.srv._face_detector import FaceDetector_Response as Response
