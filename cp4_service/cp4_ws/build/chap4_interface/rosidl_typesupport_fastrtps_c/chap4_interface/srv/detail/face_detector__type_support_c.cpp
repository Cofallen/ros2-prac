...
#include "chap4_interface/srv/detail/face_detector__rosidl_typesupport_fastrtps_c.h"
...
#include "chap4_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_chap4_interface
...
using _FaceDetector_Request__ros_msg_type = chap4_interface__srv__FaceDetector_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_chap4_interface
size_t get_serialized_size_chap4_interface__srv__FaceDetector_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FaceDetector_Request__ros_msg_type * ros_message = static_cast<const _FaceDetector_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FaceDetector_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_chap4_interface__srv__FaceDetector_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_chap4_interface
size_t max_serialized_size_chap4_interface__srv__FaceDetector_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = chap4_interface__srv__FaceDetector_Request;
    is_plain =
      (
...
static size_t _FaceDetector_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_chap4_interface__srv__FaceDetector_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chap4_interface, srv, FaceDetector_Request)() {
...
using _FaceDetector_Response__ros_msg_type = chap4_interface__srv__FaceDetector_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_chap4_interface
size_t get_serialized_size_chap4_interface__srv__FaceDetector_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FaceDetector_Response__ros_msg_type * ros_message = static_cast<const _FaceDetector_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_chap4_interface__srv__FaceDetector_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_chap4_interface
size_t max_serialized_size_chap4_interface__srv__FaceDetector_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = chap4_interface__srv__FaceDetector_Response;
    is_plain =
      (
...
static size_t _FaceDetector_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_chap4_interface__srv__FaceDetector_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chap4_interface, srv, FaceDetector_Response)() {
...
// already included above
// #include "chap4_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "chap4_interface/srv/face_detector.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chap4_interface, srv, FaceDetector)() {
