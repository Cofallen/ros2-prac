...
#ifndef CHAP4_INTERFACE__SRV__DETAIL__FACE_DETECTOR__FUNCTIONS_H_
#define CHAP4_INTERFACE__SRV__DETAIL__FACE_DETECTOR__FUNCTIONS_H_
...
#include "chap4_interface/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_chap4_interface
bool
 ...
 * calls
 * chap4_interface__srv__FaceDetector_Request__init().
...
/**
 * It calls
 * chap4_interface__srv__FaceDetector_Request__fini()
 ...
 * chap4_interface__srv__FaceDetector_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * chap4_interface__srv__FaceDetector_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chap4_interface__srv__FaceDetector_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chap4_interface
...
/**
 * It calls
 * chap4_interface__srv__FaceDetector_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chap4_interface
...
/**
 * It allocates the memory for the array and calls
 * chap4_interface__srv__FaceDetector_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chap4_interface
...
/**
 * It calls
 * chap4_interface__srv__FaceDetector_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHAP4_INTERFACE__SRV__DETAIL__FACE_DETECTOR__FUNCTIONS_H_
